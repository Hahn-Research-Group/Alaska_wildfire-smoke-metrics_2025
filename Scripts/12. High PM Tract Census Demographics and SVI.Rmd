...
run_tests %>%
  ...
  column_spec(2:4, align = "c") %>%  # Center-align numeric columns
  row_spec(which(run_tests$p_adj < 0.05), bold = TRUE, color = "black", background = "#ffeeba")  # Highlight significant rows
