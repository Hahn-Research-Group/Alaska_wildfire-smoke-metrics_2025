...
A bivariate map was then created of wildfire smoke exposure and WFSVI by Census tract. Due to the strong variability in Alaskan Census tract size, separate vector graphics were created of all Census tracts in the Anchorage Borough and for Census tracts in the Fairbanks North Star Borough. These two graphics were then arranged with the larger bivariate map as borough pop-outs in the vector graphics editor <i> Inkscape </i>.   
